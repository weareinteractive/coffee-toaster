(function() {
  ...
  Toast = (function() {
    ...
    Toast.prototype._toast = function(srcpath, params) {
      var alias, builder, config, folder, i, item, releaseDir, v, vpath, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (params == null) {
        params = {};
      }
      ...
      releaseDir = path.join(this.basepath, path.dirname(params.release));
