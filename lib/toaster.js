(function() {
  ...
  Toast = (function() {
    ...
    Toast.prototype._toast = function(srcpath, params) {
      var alias, builder, config, folder, i, item, v, vpath, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (params == null) {
        params = {};
      }
      ...
      if (!fs.existsSync(path.join(this.basepath, path.dirname(params.release)))) {
  ...
  Builder = (function() {
    ...
    */
    ...
    Builder.prototype._build_ns_tree = function(tree, folderpath) {
      var folder, folders, include, item, _i, _j, _len, _len1, _ref, _results;
      ...
      for (_i = 0, _len = folders.length; _i < _len; _i++) {
        ...
        if (include) {
          _results.push(this._build_ns_tree((tree[folder.match(/[^\/\\]+$/m)] = {}), folder));
        } else {
